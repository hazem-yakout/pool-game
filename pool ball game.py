...
pygame.display.set_caption("[HAZEM]- Pool Game")
...
cue_image = pygame.image.load('D:\cue.png').convert_alpha()
t_image = pygame.image.load(r'D:\table.png').convert_alpha()
balls_imgs = []
for imo in range(1,17):
    ball_img = pygame.image.load(fr'D:\ball_{imo}.png').convert_alpha()
